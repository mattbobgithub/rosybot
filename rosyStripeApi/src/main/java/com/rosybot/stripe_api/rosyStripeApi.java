...
try {
	...
	RosyOrder roUpdated = ros.getRosyOrder(ro, "OrderId");
	
	String confirmationSmsMessageText = "Your Order# is " + fulfillmentId
	...
	Message message = Message.creator(new PhoneNumber(roUpdated.getCustomerPhone()),
